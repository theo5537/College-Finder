...
const CollegeCard = ({ college }) => {
  return (
    <div className="bg-gray-800 rounded-xl shadow-lg p-0 flex flex-col gap-3 hover:scale-[1.03] hover:shadow-2xl transition-transform duration-200 animate-fade-in overflow-hidden">
      {/* College Image */}
      <img
        src={college.photo}
